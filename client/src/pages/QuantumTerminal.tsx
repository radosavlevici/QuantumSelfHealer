  ...
  const executeCommand = async (e: React.FormEvent) => {
    ...
    if (cmdLower === 'help') {
      ...
      newLogs.push(
        ...
        '- Alibaba Models:',
        `  • ${AIModel.Qwen} (Alibaba's multilingual model)`,
        `  • ${AIModel.QwenVL} (Visual language version)`,
        '- Microsoft Models:',
        `  • ${AIModel.Copilot} (Microsoft's assistant)`,
        `  • ${AIModel.CopilotPro} (Enhanced version)`,
        '- Combined Approaches:',
        `  • ${AIModel.Quantum} (Hybrid approach using 2 models)`,
        `  • ${AIModel.SuperQuantum} (Enhanced hybrid with 4 models)`,
        `  • ${AIModel.UltraQuantum} (Advanced hybrid with 5 models)`,
        `  • ${AIModel.MegaQuantum} (Revolutionary hybrid with all 7 models)`,
        '',
